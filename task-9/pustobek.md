...
### 7. Оптимизация потоков
В остаточной сети не найдено увеличивающих путей, следовательно, алгоритм завершил работу. Но можно перенаправить потоки и увеличить максимальный поток. Если мы перенесем 2 потока с дуги CB на дугу CT, то получится запустить еще два потока по пути s -> a -> b -> t.
Скорректируем соответствующим образом локальные потоки в исходной сети.
...
Найденный поток величиной 21 является максимальным для данной сети.
...
|---|:--------------------------------|:--------------|:------------------------------:|
| 1 | s                               | a, b, c, d, t    |         6+7+8=21             |
|   | **s + одна вершина из a, b, c, d** |               |                                |
| 2 | s, a                            | b, c, d, t       |        6+7+8=21         |
| 3 | s, b                            | a, c, d, t       |         6+7+8+9=30         |
| 4 | s, c                            | a, b, d, t       |        6+8+5+6=25       |
| 5 | s, d                            | a, b, c, t       |         6+7+4+6=23     |
|   | **s + пара вершин из a, b, c, d**  |               |                                |
| 6 | s, a, b                         | c, t          |       7+8+9=24         |
| 7 | s, a, c                         | b, t          |          8+6+5+6=25      |
| 8 | s, b, c                         | a, t          |         6+8+9+6=29       |
| 9 | s, a, d                        | c, b, t          |       7+6+4+6=23        |
| 10 | s, c, d                         | a, b, t          |       6+5+6+6=23       |
| 11 | s, b, d                         | a, c, t          |        6+7+9+4+6=32         |
|   | **s + три вершины из a, b, c, d**  |               |                                |
| 12 | s, a, b, c                      | d, t             |        8+9+6=23           |
| 13 | s, a, b, d                      | c, t             |            7+9+4+6=26      |
| 14 | s, a, c, d                      | b, t             |        6+5+6+6=23          |
| 15 | s, c, b, d                      | a, t             |          6+6+9+6=27        |
|   | **s + четыре вершины из a, b, c, d**  |               |                                |
| 16 | s, a, b, c, d                      | t             |          6+6+9=21          |
