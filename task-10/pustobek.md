...
|:----------------------------------------------|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:------:|
| Пропускная способность p(e)                   | 18 | 5  | 6  | 10 | 5  | 4  | 3  | 8  | 4  | 8  |        |
| Локальный поток f(e)                          | 18 | 5  | 6  | 7  | 5  | 3  | 1  | 8  | 4  | 6  |        |
| Стоимость транспортировки единицы потока c(e) | 2  | 2  | 3  | 2  | 1  | 1  | 1  | 2  | 4  | 5  |        |
| Суммарная стоимость f(e)*c(e)                 | 36 | 10 | 18 | 14 | 5  | 3  | 1  | 16 | 16  | 30 | **149** |

Стоимость полученного потока составляет 149. 

### Ответ:
Максимальный поток в сети равен 18, минимальная стоимость потока 149, она реализуется следующим локальными потоками:
