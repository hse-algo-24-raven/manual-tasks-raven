...
| Суммарная стоимость f(e)*c(e)                 | 36 | 10 | 15 | 16 | 5  | 1  | 0  | 12 | 16  | 40 | **151** |

Стоимость полученного потока составляет 151. 
...
В остаточной сети найден ориентированный цикл отрицательной стоимости b -> c -> d -> t -> b (1 + 1 - 5 + 2 = -1). 
...
Минимальный вес ребра в цикле 1 - это неиспользованный резерв ребер t -> b.
...
|:----------------------------------------------|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:------:|
| Пропускная способность p(e)                   | 18 | 5  | 6  | 10 | 5  | 4  | 3  | 8  | 4  | 8  |        |
| Локальный поток f(e)                          | 18 | 5  | 6  | 7  | 5  | 3  | 0  | 8  | 4  | 6  |        |
| Стоимость транспортировки единицы потока c(e) | 2  | 2  | 3  | 2  | 1  | 1  | 1  | 2  | 4  | 5  |        |
| Суммарная стоимость f(e)*c(e)                 | 36 | 10 | 18 | 14 | 5  | 1  | 0  | 16 | 16  | 30 | **146** |

Стоимость полученного потока составляет 146. 

### Ответ:
Максимальный поток в сети равен 18, минимальная стоимость потока 146, она реализуется следующим локальными потоками:
